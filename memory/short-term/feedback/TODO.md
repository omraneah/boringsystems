...
## Crystallization into mid-term SOPs (high priority)
...
- `stable/feedback_code_change_gate.md` → §Code change flow (gates 1/2/3 are already in workspace-workflow.md; this file can point there)
