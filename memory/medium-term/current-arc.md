...
- **Body, place, family, sleep, presence — non-negotiable, intact every day.** [[Engagement-Validity-Filter]] is the operational test for any engagement.
- **Deep market reading continuing.** How the market is shifting, what shapes of mandate exist, who the decision-makers are. Mapping is fun. Highest risk is shortcutting it.
...
The 2-3yr sprint that builds the long-term path to the North Star starts emerging during this phase. **Shape stays open by design** (per I-AM Creator-statement and [[Path-Doctrine]]). By end of December, the shape should be **clearer**, not committed.
...
2. **Don't shortcut letting-life-guide-me.** The Singer-shape is the discipline. Per I-AM Philosophy: *"The path shows itself as it's walked. Don't pre-commit the shape; commit the being."* Operational practice: [[Surrender-Doctrine]].
...
Not a mood tracker. A directional signal. Example: a conversation about a potential collaboration that starts heavy and ends lighter = good direction. A scope that feels pressured and depleting from first contact = wrong direction, regardless of money or logic.
