...
Action: schedule a focused pass during a weekly consolidation. Rewrite each flagged sentence to be timeless or relocate to medium-term. Rule enforced by H7 (transient-ref hook) on commits to `memory/long-term/`.
