...
Cette pièce pose la doctrine. Sa compagne — *[Le harness que je fais tourner](/fr/building/the-harness-i-actually-run)* — est la visite guidée de la mienne, concrètement. Lisez-les dans l'ordre que vous voulez. Celle-ci explique *pourquoi*. L'autre montre *quoi*.
...
La version concrète — arborescence de fichiers, diagramme mermaid, tous les hooks que je fais tourner, et la manière dont je structure memory et personas — est dans *[Le harness que je fais tourner](/fr/building/the-harness-i-actually-run)*. À lire quand vous êtes prêt à copier des formes.
