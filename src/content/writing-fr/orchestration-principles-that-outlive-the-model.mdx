...
description: "Le modèle dans votre IDE aujourd'hui sera remplacé avant la fin de l'année. La couche d'orchestration enveloppée autour de lui est ce qui se compose avec vous. Sept principes opérationnels pour construire la boucle qui survit à la prochaine release de modèle."
date: 2026-04-27
highlight: true
featured: true
order: 1
...
Cette pièce, c'est les principes opérationnels de cette couche. Sept. Ils sont en aval de la barre engineering — *[Engineering Practice Boundaries — Une seule barre pour engineers et AI](/fr/writing/engineering-principles-that-outlive-the-stack)* couvre cette barre en entier, et tout ce qui suit la présuppose. Ces sept-là sont ce que vous ajoutez par-dessus une fois acceptez que l'agent lui-même est commodity.
...
Ça veut dire architecture et boundaries, séparation des préoccupations, fixes en cause racine, planning et reviewability, qualité de code (KISS, YAGNI, DRY), documentation, testing. Pas de barre séparée et plus basse pour le code "AI-generated" ou le tooling "personnel". La version complète est dans *[Engineering Practice Boundaries — Une seule barre pour engineers et AI](/fr/writing/engineering-principles-that-outlive-the-stack)*. Tout ce qui se construit dans l'orchestration en hérite.
...
Ce qui marche pour les humains marche pour les agents. Plus de contexte aide. Corriger aide. Guider aide. La boîte à outils de management qu'on utiliserait sur un new hire est la même qu'on fait tourner sur un coding agent — et c'est l'orchestration qui permet de la faire tourner pour de vrai.
...
La pièce compagnon engineering — *[Engineering Practice Boundaries — Une seule barre pour engineers et AI](/fr/writing/engineering-principles-that-outlive-the-stack)* — couvre la couche pratique en dessous de l'orchestration. À lire en deuxième ; c'est la barre sur laquelle tout ce qui précède repose.
