---
title: "The Agent Harness That Runs 80% of My Work"
description: "A field tour of the personal agent harness that carries roughly 80% of my daily work — skills, personas, hooks, connectors, and memory — in one version-controlled workspace that moves across machines."
date: 2026-04-24
highlight: true
featured: true
order: 1
...
The operating theory behind the three-layer split, and why git underneath it is non-negotiable, is in *[Context is the Edge](/en/writing/context-is-the-edge)*.
...
<LeadMagnet
  ...
  lang="en"
  articleTitle="The Agent Harness That Runs 80% of My Work"
