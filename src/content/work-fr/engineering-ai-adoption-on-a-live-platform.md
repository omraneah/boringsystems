...
Comment le résultat ci-dessus a été mesuré — les métriques qui résistaient au gaming, et celles que j'ai écartées — c'est dans *[Les métriques d'adoption IA qui ont survécu au contact](/fr/writing/the-ai-adoption-metrics-that-survived-contact)*, le compagnon de mesure de ce case file.
