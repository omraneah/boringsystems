...
The concrete version — file tree, mermaid diagram, every hook I actually run, and how I structure memory and personas — is in *[The Agent Harness That Runs 80% of My Work](/en/building/the-harness-i-actually-run)*. Read it when you are ready to copy shapes.
