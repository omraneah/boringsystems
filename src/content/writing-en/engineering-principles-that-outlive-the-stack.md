...
These principles live in documentation until they are institutionalized — turned into shared boundary documents that both humans and tools apply consistently. The case file *[Establishing Cross-Surface Architecture Governance](/en/work/architecture-governance)* shows what that looks like in a live platform: how principle-level documents became an authoritative governance layer rather than static reference material. Two companion case files show the same principles under delivery pressure: *[Reclaiming System Ownership Under Vendor Lock-In](/en/work/breaking-vendor-lock-in)* and *[Hardening a Live Platform for Enterprise Readiness](/en/work/saas-hardening)*.
