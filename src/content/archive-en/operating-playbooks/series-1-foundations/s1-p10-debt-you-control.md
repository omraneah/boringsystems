...
1. **Blocking Risks (Revenue-Linked)** — Fragilities that directly prevent main initiatives from landing.

2. **Bomb Risks (Fragility-Linked)** — Fragilities that may never explode, but if they do → existential damage.
