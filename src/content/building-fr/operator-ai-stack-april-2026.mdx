...
Deux pieces plus profonds sur pourquoi ça compte : *[Context is the Edge](/fr/writing/context-is-the-edge)* — sur pourquoi le contexte projet est la chose qui compose d'une session à l'autre — et le piece CTO cité plus haut, qui argumente pourquoi le jugement d'operator ne s'externalise pas, même dans un monde AI-augmented.
