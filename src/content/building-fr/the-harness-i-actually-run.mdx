---
title: "L'agent harness qui fait tourner 80% de mon travail"
description: "La visite guidée de l'agent harness personnel qui porte environ 80% de mon travail quotidien — skills, personas, hooks, connectors, memory — dans un workspace versionné qui me suit d'une machine à l'autre."
date: 2026-04-24
highlight: true
featured: true
order: 1
...
La théorie opérationnelle derrière ce split en trois couches, et pourquoi git dessous est non-négociable, est dans *[Context is the Edge](/fr/writing/context-is-the-edge)*.
...
<LeadMagnet
  ...
  lang="fr"
  articleTitle="L'agent harness qui fait tourner 80% de mon travail"
