...
Specialized expert personas Ahmed can switch into for focused conversations across distinct dimensions of his current professional life: GTM, engineering, and inner-game/career.

## Current personas

| Agent | Role | Invoke for |
|---|---|---|
| `gtm-strategist` | **Naomi Renard** — senior GTM strategist, French-market grounded, distribution craft | Positioning, narrative, Enakl rebrand, offer stress-testing, pitch shape, LinkedIn/DM drafting, inbound reads |
...
>
> The voices, backstories, and reference figures (April Dunford, Gary Vee, Camille Fournier, Charity Majors, Jung, etc.) were chosen by Claude as plausible archetypes for the depth and craft Ahmed described. **Ahmed has not vetted the reference figures himself** and may find on actual use that one or more personas:
...
>
> **After each substantive session with a persona, Ahmed should ask himself: did this voice serve me, or did it get in the way?** Iterate the agent file based on the answer. Don't preserve a voice that isn't working — rewrite it.
